...
<section class="main_container">
    <div class="finalists_inner">
        ...
        <!--Awaiting Mark Higgs-->
        <div class="finalist">
            <img class="finalist_hex" src="http://img2.email2inbox.co.uk/2017/bii/jennifer_kuhn.png" alt="Mark Higgs">
            <div class="finalist_name">Mark Higgs</div>
            <div class="finalist_location">Castle Inn, Edgehill, Banbury, Warwickshire </div>
        ...
        <div class="finalist">
            ...
            <div class="finalist_location">The Windsor Fenchurch, London</div>
            <div class="finalist_bio">
        ...
        <div class="finalist">
            ...
            <div class="finalist_location">Bletchingly Arms, Redhill, Surrey</div>
            <div class="finalist_bio">
        ...
        <div class="finalist">
            ...
            <div class="finalist_location">The Kings Head, Hursley, Hampshire </div>
            <div class="finalist_bio">
        ...
        <div class="finalist">
            ...
            <div class="finalist_location">Merchants 1688, Lancaster, Lancashire</div>
            <div class="finalist_bio">
        ...
        <div class="finalist">
            ...
            <div class="finalist_location">The Waggon Inn, Uppermill, Lancashire</div>
            <div class="finalist_bio">
